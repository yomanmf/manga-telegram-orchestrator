...
test("uses bounded downloads, batched PDF checkpoints, and stored archives", () => {
  assert.match(source, /imageUrls\.slice\(\s*pageStart,\s*pageStart \+ pageLimit/);
  assert.match(source, /mapWithConcurrency\(\s*selectedUrls,\s*WEEBCENTRAL_IMAGE_CONCURRENCY/);
